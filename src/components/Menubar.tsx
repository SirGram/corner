    ...
    <nav className="fixed top-2 flex justify-center w-full items-start text-lg z-30">
      <div className="flex flex-col items-center">
        <div className="flex items-center">
          <div className="flex gap-3 px-1 bg-base-100 dark:bg-darkBase-100 rounded-base border-base border-border dark:border-darkBorder bg-base relative overflow-hidden">
            <div
