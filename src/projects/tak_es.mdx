...
<br />
Tak es un juego de mesa similar a chess con 2 jugadores donde puedes mover varias piezas durante un turno mientras intentas crear puentes entre lados.
...
<br />
- Local y multijugador
- Sistema de mensajes
- Historial de movimientos
- Lobby y salas
- Efectos de sonido
- Representación de tablero 2D
...
<img src={Img0} alt="Tak Pieces Blender" className="rounded-base overflow-hidden border-base border-border" />
<br />
## Desafíos
...
<br />
Un tablero normalmente se representa como una matriz 2D. Para transformar esa representación en un tablero 3D, escribí esta función:
...
<br />
Cuando comencé a programar este proyecto, no sabía cómo jugar al juego. Después de intentar, es un juego relajante con profundidad sorprendente.